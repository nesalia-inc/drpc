...
The `t.mutation()` function is a higher-order function. It takes a definition object with `args` and `handler`, and returns a procedure you can call or register in a router:
...
This example shows a full mutations implementation with createUser, updateUser, and deleteUser:
