 ...
 */
export declare function event({ args }: {
    args: z.ZodType;
}): EventDefinition;
/**
 ...
 */
export declare function eventNamespace<N extends string, Events extends Record<string, EventDefinition>>(config: {
    name: N;
    events: Events;
}): Events;
/**
 ...
 */
export declare const eventsNamespace: typeof eventNamespace;
